...
export default function Footer() {
  ...
  return (
    <div ref={footerRef}>
      <section className="h-70 md:h-dvh p-2 mt-20 md:mt-0">
      ...
      <div className="from-[#181717] to-[#b1a6962b] bg-gradient-to-b">
        ...
        <section className="space-y-5">
          ...
          <div>
            <div className="text-[90px] md:text-[200px] lg:text-[350px] text-center font-semibold bg-gradient-to-b from-[#9f9380] to-[#f4efe7] bg-clip-text text-transparent">
              Capsule®
            </div>
          </div>
        </section>
